 ...
 * @since 14/11/2009
 */
public class ListaStatus extends ListaModelo {
    ...
    public void setElementAt(Object objeto, int posicao) {
        listaStatus.set(posicao, (StatusDefinicao)objeto);
    }
    ...
    public void addElement(Object objeto) {
        listaStatus.add((StatusDefinicao) objeto);
    }
     ...
     */
    @Override
    public List<StatusDefinicao> getList() {
        return listaStatus;
    }
    ...
    public void removeElement(Object objeto) {
        listaStatus.remove((StatusDefinicao) objeto);
    }
    ...
    public Object getElementAt(int arg0) {
        return (StatusDefinicao) listaStatus.get(arg0);
    }
